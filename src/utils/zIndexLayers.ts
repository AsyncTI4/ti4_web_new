 ...
 */
export function getUnitZIndex(unitType: string, stackIndex: number = 0): number {
  const basePriority = Z_INDEX_LAYERS.UNIT_PRIORITIES[unitType as keyof typeof Z_INDEX_LAYERS.UNIT_PRIORITIES] || Z_INDEX_LAYERS.UNIT_BASE;
