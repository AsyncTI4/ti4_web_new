...
export const techs: Tech[] = [
  ...
  },
  {
    ...
    name: "Agency Supply Network",
    types: ["CYBERNETIC"],
    text: "Once per action, when you resolve one a unit's PRODUCTION ability: You may resolve another of your unit's PRODUCTION abilities in any system.",
    source: "twilights_fall",
    faction: "keleres",
  },
  {
  ...
  },
  {
    ...
    name: "Foresight",
    types: ["PROPULSION"],
    text: "After another player moves ships into a system that contains 1 or more of your ships: You may place 1 token from your strategy pool in an adjacent system that does not contain another player's ships; move your ships from the active system into that system.",
    source: "twilights_fall",
    faction: "naalu",
  },
  {
  ...
  },
  {
    ...
    name: "Temporal Command Suite",
    types: ["CYBERNETIC"],
    text: "After any player's genome becomes exhausted: You may spend 3 influence to ready that genome; if you ready another player's genome you may perform a transaction with that player. ",
    source: "twilights_fall",
    faction: "nomad",
  },
  {
