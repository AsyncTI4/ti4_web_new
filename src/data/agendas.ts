export const agendas = [
  ...
  },
  {
    ...
    target: "For/Against",
    text1:
      "For: Alpha and beta wormholes have no effect during movement. [Note: this only affects normal wormhole adjacency. Ghost agent, other agenda laws, and the AC lost star chart will overrule this.]",
    text2:
