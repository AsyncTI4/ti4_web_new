...
export const units: Unit[] = [
  ...
  },
  {
    ...
    isStructure: true,
    ability:
      "The resource value of this planet is increased by 2. [Note: unconfirmed]",
  },
  {
    id: "belkosea_fighter",
    baseType: "fighter",
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "While this unit is being transported, choose 1 unit in its system that has a capacity value to roll 1 additional die on its combat roll.",
  },
  {
    id: "cabal_flagship",
    baseType: "flagship",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "While this unit is in or adjacent to a system that contains an active breach, other players' units in systems  with active breaches lose all of their unit abilities.",
  },
  {
    id: "crimson_mech",
    baseType: "mech",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "DEPLOY: At the start of your turn, you may destroy one of your abilities to place this unit from your reinforcement into a system that contains your ships.",
  },
  {
    id: "redtf_mech",
    baseType: "mech",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "Keep this card in your play area [it does not count as a real flagship unit]; decres the combat value of your flagship by 1, increase the number of combat dice it rolls by 1, increase its move value by 1, and increase its capacity by 2.",
  },
  {
    ...
    isGroundForce: true,
    ability:
      "Keep this card in your play area [it does not count as a real mech]; your mechs roll 1 additional die during combat.",
  },
  {
    ...
    isGroundForce: true,
    ability:
      "Keep this card in your play area [it does not count as a real mech]; the COMBAT value of your mechs is reduced by 1.",
  },
  {
    id: "tf-exile",
    baseType: "destroyer",
  ...
  },
  {
    ...
    baseType: "fighter",
    asyncId: "ff",
    name: "Hybrid Cystral Fighter (TF)",
    source: "twilights_fall",
    faction: "naalu",
    moveValue: 2,
    capacityUsed: 1,
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "Keep this card in your play area [it does not count as a real mech]; the COST of your mechs is reduced by 1.",
  },
  {
    id: "tf-vortexer",
    baseType: "carrier",
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "After this unit is destroyed, place the unit on this card. At the start of the status phase, place each unit that is on this card on a planet you control.",
  },
  {
