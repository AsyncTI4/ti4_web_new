...
export const units: Unit[] = [
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "Your other units in this system may also have the unit abilities and text abilities of another player’s units of the same type in or adjacent to this system. [Note: not currently implemented by the bot]",
  },
  {
    id: "atokera_mech",
    baseType: "mech",
