...
export const planets: Planet[] = [
  ...
  },
  {
    ...
    planetType: "NONE",
    cardImagePath: null,
    techSpecialties: ["NONUNITSKIP"],
    legendaryAbilityName: "Desolate Outpost",
    legendaryAbilityText:
      "This system is considered to not have any planets. When you exhaust this planet for its technology skip, you may explore a frontier token in this system, if one is present, or place one if not.",
    source: "asteroid",
  },
  {
    id: "abaddon",
    tileId: "75",
    name: "Abaddon",
    aliases: ["abaddon", "abadon", "abadd", "abandon", "75_2"],
    resources: 1,
    influence: 0,
    factionHomeworld: null,
    planetType: "CULTURAL",
  ...
  },
  {
    ...
    flavourText:
      "A bleak wasteland of toxic gas, the most accessible parts of the planetary surface are covered in tailings and industrial waste from nearby Telahas.",
    source: "eronous",
  },
  {
    id: "aeva",
  ...
  },
  {
    ...
    flavourText:
      "While its surface is barren, sprawling undergound cities house millions. It has served as a vault for valuable artifacts and data-matrices.",
    source: "eronous",
  },
  {
    id: "ako40m",
    ...
    influence: 1,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "Gravitational Gambit",
    legendaryAbilityText:
      "At the end of your turn, you may exhaust this card to roll a die. On a result of 1-3 purge each attachment to this planet, and remove all units on this planet from the game board. Otherwise, attach an Improvement card to this planet. Improvement: ATTACH: This planet's resource and influence values are each increased by 1.",
    flavourText:
      "Actively being torn apart by a gravity rift. A fact that itself does not deter the brave. Mining operations have remained strong even as the planet is full further towards its doom.",
    source: "eronous",
  },
  {
    id: "akredrite",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Zazu's Petition",
    legendaryAbilityText:
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "As a key fuel and weaponry supplier in its sector, Aranndan wields unusual power in the diplomatic halls of the galaxy.",
    source: "eronous",
  },
  {
    id: "aranndanb",
  ...
  },
  {
    ...
    legendaryAbilityName: null,
    legendaryAbilityText: null,
    flavourText: "*Gotta Try Harder Next Time*",
    source: "other",
  },
  {
    id: "archonren",
  ...
  },
  {
    ...
    tileId: "75",
    name: "Ashtroth",
    aliases: ["ashtroth", "ashtros", "ashtrot", "75_3"],
    resources: 2,
    influence: 0,
    factionHomeworld: null,
    planetType: "HAZARDOUS",
  ...
  },
  {
    id: "avernus",
    name: "Avernus",
    aliases: ["avernus", "stargate", "averns", "muaatbt"],
    resources: 2,
    influence: 0,
    planetTypes: ["HAZARDOUS"],
  ...
  },
  {
    ...
    techSpecialties: ["CYBERNETIC"],
    flavourText:
      "The Couriel Plains of Behjan are notorious for its roaming mobs of cybernetically enhanced experimental subjects.",
    source: "eronous",
  },
  {
    id: "bellatrix",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "The Wasteland",
    legendaryAbilityText:
      "When you explore Bozgarbia, draw 1 card from each planet exploration deck. Choose 1 to resolve, and discard the rest.\nYou may exhaust this card at the end of your turn to explore Bozgarbia",
    legendaryAbilityFlavourText:
      "*Thousands of years of garbage fills once majestic canyons, endlessly strewn over the moon's surface. Who knows what ancient treasure lays amongst the trash?*",
    flavourText:
      "*A solitary moon, which orbits the home of a once-great civilization, and served as the principal repository for its waste material.*",
    source: "sigma",
  },
  {
    id: "brakke",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Located nearby an inportant gateway. A great network of bunkers and military installations are interwoven both on the surface and deep underground.",
    source: "eronous",
  },
  {
    id: "briareus",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Ancient Stronghold",
    legendaryAbilityText:
      "You may place an additional PDS on this planet. Your PDS on this planet have their range increased by 1.",
    source: "asteroid",
  },
  {
    id: "cahgaris",
  ...
  },
  {
    ...
    influence: 4,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "The Starlight Throne",
    legendaryAbilityText:
      "When you gain this card, gain 1 victory point; when you lose this card, lose 1 victory point. You score last during the status phase.",
    flavourText:
      "Cantris is scarred by the violent invasions of warring galactic factions.",
    source: "eronous",
  },
  {
    id: "capha",
  ...
  },
  {
    ...
    influence: 3,
    planetTypes: ["CULTURAL"],
    legendaryAbilityName: "Sacrifice",
    legendaryAbilityText:
      "When you exhaust Casibann to spend its resources or influence, you may exhaust this card to remove any number of infantry on that planet to spend them as resources or influence as well.",
    flavourText:
      "A technologically backwards planet that is known for its unique religion. Its isolated populace worships starfaring vessels and their crew like gods.",
    source: "eronous",
  },
  {
    id: "cealdri",
  ...
  },
  {
    ...
    influence: 1,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "Desperation",
    legendaryAbilityText:
      "At the start of a ground combat on a planet you control, you may exhaust this card to choose 1 ground force in the active system; that ground force rolls 1 additional die during each round of that ground combat.",
    source: "eronous",
  },
  {
    id: "cerberuscpti",
  ...
  {
    id: "custodiavigiliaplus",
    tileId: null,
    name: "Custodia Vigilia (Plus)",
    shortName: "Cust. Vigilia",
    shrinkNamePNAttach: true,
    aliases: [
      "custodiavigiliaplus",
      "custodiavigilia(plus)",
      "custodia vigilia",
      "custodia",
      "vigilia",
      "cust",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "placeholder",
    legendaryAbilityText:
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Fractal Gate",
    legendaryAbilityText:
      "You may exhaust this card at the end of your turn to remove 1 of your ships from the game board and place that unit in an adjacent system that does not contain another player’s ships. [Note: Place means ignore all anomaly restrictions. Transport is not possible with placing]",
    source: "uncharted_space",
  },
  {
    id: "dorvok",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "A year on Dwuuit is exactly a third of a year on nearby Uhott. Triannual street celebrations mark the passing of green Uhott far overhead.",
    source: "eronous",
  },
  {
    id: "ecconv",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Bi-Phasic Generators",
    legendaryAbilityText:
      "You may exhaust this card at the end of your turn to place 1 frontier token in a system that does not contain a planet. [Note: only 1 frontier token can be in a system at any time]",
    source: "uncharted_space",
  },
  {
    id: "edyn",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Largest of the Elok planetoids, it is home to the largest of the Empyrean outposts. It is here where volatile energies are harvested.",
    source: "eronous",
  },
  {
    id: "elokphi",
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "The Elok nebula is not the largest, but it has long been home to Empyrean outposts.",
    source: "eronous",
  },
  {
    id: "elysium",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "A beautiful planet from orbit, Erissiha is an otherwise small planet with modest industry and political sway.",
    source: "eronous",
  },
  {
    id: "erodius",
  ...
  },
  {
    ...
    tileId: "98",
    name: "Garbozia",
    aliases: ["garbozia", "garbage"],
    resources: 2,
    influence: 1,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "Dok 'N Pic's Salvage Yard",
    legendaryAbilityText:
      "Exhaust this card when you pass to place 1 action card from the discard pile faceup on this card; you can purge cards on this card to play them as if they were in your hand.",
    legendaryAbilityFlavourText: "Throw 'er on the 'eap with the rest.",
    planetLayout: {
      unitHolderName: "garbozia",
      resourcesLocation: "BottomLeft",
      centerPosition: {
        x: 170.0,
        y: 150.0,
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Sunsets on Ghanis glow violently orange in the low-horizon particulate waste of its massive industrial belts.",
    source: "eronous",
  },
  {
    id: "ghoti",
    ...
    legendaryAbilityText:
      "When you move 1 or more ships into a system that contains no planets, gain 1 commodity. You may score objectives if your home system contains no planets.",
    source: "ds",
  },
  {
    id: "golga",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Grywon prides itself on its colorful mycelium gardens, the remnants of its original biome, now wrapped inside heavily urbanised but environmentally homeostatic cityscapes.",
    source: "eronous",
  },
  {
    id: "grywonb",
  ...
  },
  {
    ...
    influence: 5,
    planetTypes: ["CULTURAL"],
    legendaryAbilityName: "Betrayers' Dagger",
    legendaryAbilityText:
      "Before a player casts votes, you may exhaust this card to choose a player; that player must give you 1 promissory note from their hand, or cast at least 1 vote for the outcome of your choice on that agenda.",
    source: "eronous",
  },
  {
    id: "heska",
    ...
    techSpecialties: ["CYBERNETIC"],
    flavourText:
      "The several private research stations dotting the large southern continent are responsible for the bulk of economic activity.",
    source: "eronous",
  },
  {
    id: "hevahold",
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "The seas are polluted by an unknown ancient industrial disaster caused by the civilisation whose ruins cover the northern polar regions.",
    source: "eronous",
  },
  {
    id: "hevaholdb",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "A sentient but pre-technological species remains quarantined in the western hemisphere. Relations with local colonies are strained.",
    source: "eronous",
  },
  {
    id: "hulgade",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "The verdant surface of Ikrus III is dotted with artisanal manufacturing enclaves, and produces a significant portion of all artistic supplies in its sector.",
    source: "eronous",
  },
  {
    id: "illusion",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Financial, commercial and artistic industries thrive in the temperate climate, with some small military groups providing security.",
    source: "eronous",
  },
  {
    id: "kelgate",
    ...
    influence: 2,
    planetTypes: ["INDUSTRIAL"],
    legendaryAbilityName: "Experimental Gate",
    legendaryAbilityText:
      "At the start of your turn, you may exhaust this card to treat this system as if it had an alpha and beta wormhole until the end of this tactical action.",
    flavourText:
      "The site of the first non-Cruess wormhole generation device. Powered by the heat from the planet's core. The shifting gates have led to it become an important trade hub.",
    source: "eronous",
  },
  {
    id: "keqo",
  ...
  },
  {
    ...
    techSpecialties: ["CYBERNETIC"],
    flavourText:
      "The jagged coastlines of its capital city Havvas have begun to draw new entrepreneurial investments in recent times.",
    source: "eronous",
  },
  {
    id: "kroll",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "INTERSTELLAR GATE",
    legendaryAbilityText:
      "When this card enters play, attach to it the unlocked commander of a random unchosen faction. While you control this planet, your commodity value is decreased by 1.",
    source: "lost_star_charts_of_ixth",
  },
  {
    id: "kyd",
  ...
  },
  {
    ...
    influence: 2,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "Equilibrium",
    legendaryAbilityText:
      "When a player would win a combat, you may exhaust this card to treat that combat as a draw instead",
    source: "eronous",
  },
  {
    id: "lirastra",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Lunerus shows the cooling scars of tidal disruption, but the remains of those ancient volcanic eruptions still poison the air.",
    source: "eronous",
  },
  {
    id: "lust",
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Vigorous Winds",
    legendaryAbilityText:
      "After you activate a system, you may exhaust this card to apply +1 to the movement value of up to 2 of your ships during this tactical action.",
    legendaryAbilityFlavourText: null,
    flavourText:
      "Its barren surface has been worn smooth by constant storms. Ships have long been able to take advantage of these forces and have used them to great avail.",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Asymptotic Enrichment",
    legendaryAbilityText:
      "The resource and influence value of Magrathea are each equal to the combined total victory points on face up public objectives.",
    legendaryAbilityFlavourText:
      "*The Magratheans are expert terraformers, with their homeworld being the crown jewel of their abilities. Rumors have started that they plan on building a planet from scratch in the near future.*",
    flavourText:
      "*Located in the heart of the Horsehead Nebula, the planet looks a lot different from when it was last seen by the wider universe at the end of the Age of Dusk.*",
    source: "sigma",
  },
  {
    id: "malbolge",
    ...
    influence: 3,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "Hand of Force",
    legendaryAbilityText:
      "At the start of your turn, you may exhaust this card to choose 1 of your neighbors; that player must give you 1 promissory note or 1 action card from their hand, if able.",
    flavourText:
      "Boiling swamps cover the surface. Well hidden tunnels lead to fortifed bunkers. Sealed deep within are vast libraries, any record can be found stored within their info-matrices.",
    source: "eronous",
  },
  {
    id: "mallice",
  ...
  },
  {
    ...
    techSpecialties: ["BIOTIC"],
    flavourText:
      "A hub for manufacturing, trade and research, the glowing wormhole can be seen on dark, clear nights, drifting far in the sky.",
    source: "eronous",
  },
  {
    id: "marshengurn",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "A gas-giant renowed for its stunning polar auroras. Energy harnessed from Mayris's constant storms is used to power the various space ports.",
    source: "eronous",
  },
  {
    id: "mecantor",
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "In place of a normal star, Mecantor orbits around a minor gravity rift. While within the habitable range, incoming ships must stick to pre-determined routes to avoid the dangers of the anomaly.",
    source: "eronous",
  },
  {
    id: "meccna",
  ...
  },
  {
    ...
    techSpecialties: ["PROPULSION"],
    flavourText:
      "Sheltered on the second satellite of the otherwise unremarkable gas giant Meko, the research facilities of Meko II are powered almost entirely by its hellish magnetosphere.",
    source: "eronous",
  },
  {
    id: "mellon",
  ...
  },
  {
    ...
    techSpecialties: ["PROPULSION"],
    flavourText:
      "Deep sea mining operations cloud Merjae's oceans, while its magnetosphere powers valuable engine research projects.",
    source: "eronous",
  },
  {
    id: "meth",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "A mild world that has a Jord-like composition. It has served as a Federation outpost for many generations. Numerous shipyards have formed across the landscape.",
    source: "eronous",
  },
  {
    id: "minaluk",
  ...
  },
  {
    ...
    tileId: null,
    name: "Mirage",
    aliases: ["mirage", "mirag", "miraj", "miraje", "mrag"],
    positionInTile: null,
    resources: 1,
    influence: 2,
    factionHomeworld: null,
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "On the edge of a nebula and nearby to a volatile epsilon gate. This barren planet has served many roles under its many occupants, an outpost, a shipyard, a military colony, and countless more.",
    source: "eronous",
  },
  {
    id: "morrock",
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Covered in lush forests and unique geological formations. The populace mostly consists of natives and off-world researchers.",
    source: "eronous",
  },
  {
    id: "mr",
  ...
  },
  {
    ...
    legendaryAbilityFlavourText: "Hic fiat opus galaxiae.",
    planetLayout: {
      unitHolderName: "mrte",
      resourcesLocation: "BottomLeft",
      extraIcons: 1,
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Consortium's Resolve",
    legendaryAbilityText:
      "When another player activates a system adjacent to Mecatol Rex, gain 1 trade good.\nGain 2 command tokens when another player draws a secret objective with the second clause of the 'Imperial' strategy card.",
    source: "keleresplus",
  },
  {
    id: "newalbion",
  ...
  },
  {
    ...
    legendaryAbilityFlavourText: null,
    flavourText:
      "Covered in thick ice sheets and permafrost. In the almost perpetual night, ice harvesters work for meager rations.",
    spaceCannonDieCount: 0,
    spaceCannonHitsOn: 0,
    searchTags: [],
    source: "eronous",
  ...
  },
  {
    ...
    legendaryAbilityFlavourText: null,
    flavourText:
      "Just as barren and hellish as the other planets in the Vili system. The only location of note are the Nokturn facilities located near the southern hemisphere.",
    spaceCannonDieCount: 0,
    spaceCannonHitsOn: 0,
    searchTags: [],
    source: "eronous",
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Grassy plains with small dusty mountains. The local industry revolves around hunting Norrkian buffalo.",
    source: "eronous",
  },
  {
    id: "norvus",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Desecrator",
    legendaryAbilityText:
      "When you gain control of Origin, attach this card to a planet in your home system. That planet has +2 influence.",
    source: "asteroid",
  },
  {
    id: "pax",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "The molten surface makes it uninhabitable to most. Located extremely close to a supernova in a region known as the birthplace of stars.",
    source: "eronous",
  },
  {
    id: "phaeton",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Vast filtering facilities extract salts and rare metals from the warm, shallows seas bordering Phylo's southern Ghata landmass.",
    source: "eronous",
  },
  {
    id: "phylob",
  ...
  },
  {
    ...
    influence: 0,
    planetTypes: ["INDUSTRIAL"],
    legendaryAbilityName: "Curse of Wealth",
    legendaryAbilityText:
      "At the start of the Strategy phase, you may exhaust this card and any number of planets you control to place a number of trade goods on this card equal to either the combined resource or influence value of those planets. When you ready this card, gain all trade goods on this card.",
    source: "eronous",
  },
  {
    id: "poh",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Mystic Library",
    legendaryAbilityText:
  ...
  },
  {
    ...
    planetType: "INDUSTRIAL",
    flavourText:
      "Seating at a more stable distance between the two wormholes. Prymis is the main space port. It's many orbital platforms service the thousands of ships that pass by.",
    source: "eronous",
  },
  {
    id: "qaak",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Composed mostly from ice crystals and dust. Large orbital collection platforms are used to collect and purify the ice forms.",
    source: "eronous",
  },
  {
    id: "ragh",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "A cold gas giant mostly used as a refueling station for military fleets passing through the system.",
    source: "eronous",
  },
  {
    id: "rep",
  ...
  },
  {
    ...
    legendaryAbilityFlavourText: null,
    flavourText:
      "A backwards planet with many odd customs. This is the seat of the old Winnu Empire. It is currently overseen by the Lazax Custodians.",
    spaceCannonDieCount: 0,
    spaceCannonHitsOn: 0,
    searchTags: [],
    source: "other",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Thick, partially frozen glaciers shift around on strong undercurrents. Temperatures are well below freezing and the only signs of life are research outposts.",
    source: "eronous",
  },
  {
    id: "rialarchon",
    ...
    techSpecialties: ["PROPULSION"],
    flavourText:
      "Located far from the galactic center, and further from watchful eyes. This lack of oversight has allowed for continued experiments with more temperamental drives.",
    source: "eronous",
  },
  {
    id: "rigeli",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Massive biomes of mega-ferns cover most of the surface. When processed they are an excellent and renewable food source. ",
    source: "eronous",
  },
  {
    id: "rysaa",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Sehnn gets its rusty orange color from a think layer of dusty iron rich top soil. The primary industry is to extract this iron and use it in a variety of steel products.",
    source: "eronous",
  },
  {
    id: "selen",
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Relegated for industrial usage, the surface of Selen Tu has been marked by years of resource farming. Exotic woods are grown, milled, packed, and ready to be shipped off world.",
    source: "eronous",
  },
  {
    id: "semlore",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Large fleets of sightseer craft swoop low over the northern glaciers, pushing the limits of lift in the thin, cold atmosphere.",
    source: "eronous",
  },
  {
    id: "shalloq",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Shigonas is one of the better archaeological Lazax sites, and researchers and entrepreneurs flock to it despite the poisonous atmosphere.",
    source: "eronous",
  },
  {
    id: "shihalaum",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Imperial Salvage Yard",
    legendaryAbilityText:
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Millions of visitors flock to viewing platforms around the vast super-volcano still erupting on the Erida platform of Sokaris's northern continent.",
    source: "eronous",
  },
  {
    id: "solin",
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Home to idyllic scenery and a mild climate. Strict conservation efforts have left its surface mostly untouched. Woods harvested from Selen Tu are brought to master carpenters for luxury products.",
    source: "eronous",
  },
  {
    id: "solitude",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Located along the popular Hydrian space route, this orbital station his one of many. Ringing around an energetic gas giant, it serves as a refueling station for passing vessels. ",
    source: "eronous",
  },
  {
    id: "strang",
  ...
  },
  {
    ...
    influence: 0,
    planetTypes: ["HAZARDOUS"],
    legendaryAbilityName: "Undying Legions",
    legendaryAbilityText:
      "After 1 of your infantry units is destroyed during combat, you may place that unit on this card. When you pass, you may exhaust this card to place each unit on this card on Stygain.",
    flavourText:
      "Soldiers sometimes claim to recognise fallen comrades in the swirling fog.",
    source: "eronous",
  },
  {
    id: "styx",
  ...
  },
  {
    ...
    techSpecialties: ["BIOTIC"],
    flavourText:
      "Famous for stunning views and unique mega flora. The rainbow grassy plains draw many visitors. On the Red Steppe the renowned Syvian Research Institute draws in minds from all over the galaxy.",
    source: "eronous",
  },
  {
    id: "taaldorn",
    ...
    techSpecialties: ["CYBERNETIC"],
    flavourText:
      "Vast deserts cover the northern hemisphere while lush river lands dominate the southern hemisphere. The fertile southern soil has lead to a robust agricultural industry.",
    source: "eronous",
  },
  {
    id: "tala9",
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Council Black Site",
    legendaryAbilityText:
  ...
  },
  {
    ...
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Neural Overdrive",
    legendaryAbilityText:
      "During status phase you draw an additional action card.",
    source: "somno",
  },
  {
    id: "telahas",
  ...
  },
  {
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Tethn'Sekus, though more stable than Tethn'Tirs, nonetheless remains mostly a tourist destination and exerts little galactic influence.",
    source: "eronous",
  },
  {
    id: "tethntirs",
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Tethn'Tirs is a beautiful planet but is undergoing significant tectonic upheavals due to a recent gravitic disturbance. Nonetheless it remains a popular destination among those who can afford the risk.",
    source: "eronous",
  },
  {
    id: "thar",
  ...
  },
  {
    ...
    techSpecialties: ["BIOTIC"],
    flavourText:
      "The atmosphere is a soupy hazy filled with Arborec Flaah spores. Only recently has this planet been reconnected to the Symphony.",
    source: "eronous",
  },
  {
    id: "thewatchtower",
  ...
  },
  {
    id: "thundersedge",
    name: "Thunder's Edge",
    shortName: "Thund. Edge",
    shrinkNamePNAttach: true,
    aliases: ["thunder'sedge", "thundersedge", "thunder", "te"],
    resources: 5,
    influence: 1,
    planetTypes: ["NONE"],
    ...
    legendaryAbilityFlavourText: "Heirarch online. State your request.",
    planetLayout: {
      unitHolderName: "thundersedge",
      resourcesLocation: "BottomLeft",
      extraIcons: 1,
      centerPosition: {
        x: 62,
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "When the surface is visible through the poisonous thick storms of Tir, explorers sometimes catch glimpses of abandoned structures.",
    source: "eronous",
  },
  {
    id: "torkan",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "The sprawling cities of Uhott are considered to harbor some of the best gambling dens in the galaxy.",
    source: "eronous",
  },
  {
    id: "uikos",
    ...
    resources: 1,
    influence: 1,
    factionHomeworld: "uydai",
    planetType: "FACTION",
    cardImagePath: null,
    techSpecialties: null,
    legendaryAbilityName: "Harvest",
    legendaryAbilityText:
      "After a player gains a Path token, place 1 commodity from the supply on this card. At the end of your turn, you may exhaust this card to gain all commodities on this card",
    source: "ds",
  },
  {
    id: "ultimur",
    ...
    planetTypes: ["CULTURAL"],
    flavourText:
      "Ultimur's high altitude floating penthouses provide beautiful views over the horizon for the wealthiest elite.",
    source: "eronous",
  },
  {
    id: "ultimurb",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "Warm equatorial seas have fostered a strong chain of island economies, resorts, and community organisations.",
    source: "eronous",
  },
  {
    id: "vent",
    ...
    techSpecialties: ["WARFARE"],
    flavourText:
      "Although much of the surface is blasted by weapons research, a well-established web of manufacturing guilds ensures that key habitable regions remain untouched.",
    source: "eronous",
  },
  {
    id: "verdis",
  ...
  },
  {
    ...
    techSpecialties: ["PROPULSION"],
    flavourText:
      "Once a center for surface mining, now vast cultivated forests surround cities nurturing valuable financial and scientific programs.",
    source: "eronous",
  },
  {
    id: "vigilum",
  ...
  },
  {
    ...
    legendaryAbilityFlavourText: null,
    flavourText:
      "Deep beneath the frozen soil are spawling mines. What little metal can be harvested are sent off the the facilities of Nokturn.",
    spaceCannonDieCount: 0,
    spaceCannonHitsOn: 0,
    searchTags: [],
    source: "eronous",
  },
  {
    ...
    influence: 1,
    planetTypes: ["INDUSTRIAL"],
    legendaryAbilityName: "Violent Demise",
    legendaryAbilityText:
      "At the end of a ground combat on a planet you control, you may exhaust this card to roll 3 dice. For each result of 6 or greater, destroy 1 ground force on that planet.",
    source: "eronous",
  },
  {
    id: "vioss",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Much of the surface has been cracked to access a veined marble highly prized in the construction industry.",
    source: "uncharted_space",
  },
  {
    id: "volra",
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Poisonous and unstable, the gas pits of Volra provide abundant fuel for industrials who can manage the cost of retrieving them.",
    source: "eronous",
  },
  {
    id: "vorhal",
  ...
  },
  {
    ...
    planetTypes: ["HAZARDOUS"],
    flavourText:
      "Home to a few military outposts, the habitable areas of its surface are shielded by low orbiting magneto-arrays.",
    source: "eronous",
  },
  {
    id: "vylanua",
    ...
    techSpecialties: ["WARFARE"],
    flavourText:
      "Once the native creatures had been hunted to extinction for food, the small planet was reallocated to prototype experiments.",
    source: "eronous",
  },
  {
    id: "vyseraiii",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "A large proportion of the galaxy's ornamental clay is dug from the wide deeps of Yncranti's mud wastes.",
    source: "eronous",
  },
  {
    id: "ynnis",
  ...
  },
  {
    ...
    planetTypes: ["INDUSTRIAL"],
    flavourText:
      "A flat dusty desert of a planet, the strong winds kick up blinding sandstorms. It is known for the strange religon of its inhabitants.",
    source: "eronous",
  },
  {
    id: "zohbat",
