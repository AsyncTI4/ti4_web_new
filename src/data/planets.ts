...
export const planets: Planet[] = [
  ...
  },
  {
    ...
    legendaryAbilityText:
      "When you explore Garbozia, draw 1 card from each planet exploration deck. Choose 1 to resolve, and discard the rest.\nYou may exhaust this card at the end of your turn to explore Garbozia",
    legendaryAbilityFlavourText:
