...
export const techs: Tech[] = [
  ...
  },
  {
    ...
    faction: "zephyrion",
    source: "balacasi",
    text: "ACTION: Exhaust this card to place or move any number of bounty tokens from opponent’s faction sheets to the unit space of non-fighter ships on an opponents’ faction sheet.",
  },
  {
    alias: "bio",
    name: "Bioplasmosis",
