export const gameState = {
  lawsInPlay: [
    ...
    },
    {
      ...
      mapText:
        "The elected secret objective becomes a public objective. Place it near the other public objectives in the common play area.",
      electedInfo: "Fuel the War Machine",
      electedFaction: null,
      electedType: "other",
      controlTokens: [],
      displaysElectedFaction: false,
    },
  ],
  statTilePositions: {
    sol: ["409", "410", "408"],
  ...
  tileUnitData: {
    ...
    "302": {
      space: {
        ...
        neutral: [
          {
            entityId: "creussgamma",
            entityType: "token",
            count: 1,
            sustained: null,
          },
          {
            entityId: "creussalpha",
            entityType: "token",
            count: 1,
            sustained: null,
          },
  ...
  objectives: {
    stage1Objectives: [
      ...
      },
      {
        ...
        pointValue: 1,
        revealed: true,
        scoredFactions: ["letnev", "argent", "ghost", "jolnar", "mentak"],
        peekingFactions: [],
        multiScoring: false,
      },
      {
      ...
      },
      {
        ...
        pointValue: 1,
        revealed: true,
        scoredFactions: ["ghost", "jolnar", "letnev"],
        peekingFactions: [],
        multiScoring: false,
      },
    ],
    ...
    customObjectives: [
      ...
      {
        key: "Fuel the War Machine",
        name: "Fuel the War Machine",
        pointValue: 1,
        revealed: true,
        scoredFactions: ["argent", "mentak"],
        peekingFactions: [],
        multiScoring: false,
      },
    ],
  ...
  cardPool: {
    secretObjectiveDeckSize: 20,
    secretObjectiveFullDeckSize: 40,
    actionCardDeckSize: 37,
    actionCardFullDeckSize: 120,
    actionCardDiscardSize: 59,
    actionCardPurgedSize: 0,
    culturalExploreDeckSize: 6,
    culturalExploreDiscardSize: 5,
    culturalExploreFullDeckSize: 20,
    industrialExploreDeckSize: 13,
    industrialExploreDiscardSize: 5,
    industrialExploreFullDeckSize: 20,
    hazardousExploreDeckSize: 9,
    hazardousExploreDiscardSize: 4,
    hazardousExploreFullDeckSize: 20,
    frontierExploreDeckSize: 16,
    frontierExploreDiscardSize: 2,
    frontierExploreFullDeckSize: 20,
    relicDeckSize: 9,
    relicFullDeckSize: 13,
    agendaDeckSize: 41,
  ...
  playerData: [
    {
      ...
      sleeperTokensReinf: 3,
      ghostWormholesReinf: ["creussalpha", "creussbeta", "creussgamma"],
    ...
    },
    {
      ...
      scs: [6],
      isSpeaker: false,
      neighbors: ["blue", "purple", "yellow", "navy", "pink"],
      spaceArmyRes: 46.5,
      groundArmyRes: 6.5,
    ...
    },
    {
      ...
      scs: [1],
      isSpeaker: false,
      neighbors: ["purple", "bloodred", "yellow", "pink"],
      spaceArmyRes: 52.5,
      groundArmyRes: 22.5,
    ...
    },
    {
      ...
      scs: [8],
      isSpeaker: false,
      neighbors: ["blue", "bloodred", "purple", "yellow", "navy"],
      spaceArmyRes: 19.5,
      groundArmyRes: 14.0,
    ...
    },
    {
      ...
      scs: [2],
      isSpeaker: false,
      neighbors: ["bloodred", "blue", "purple", "navy", "pink"],
      spaceArmyRes: 26.5,
      groundArmyRes: 17.0,
