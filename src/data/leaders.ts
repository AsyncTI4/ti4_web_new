...
export const leaders: LeaderData[] = [
  ...
  },
  {
    ...
    abilityWindow: "After an agenda is revealed:",
    abilityText:
      "Choose an outcome and a player. If that player votes for that outcome, they cast additional votes equal to the number of technologies that player owns that you also own. If that outcome is resolved, you count as having cast 5 votes for that outcome.",
    unlockCondition: "At the start of the agenda phase",
    source: "voices_of_the_council",
  },
  {
  ...
  },
  {
    ...
    abilityWindow: "ACTION:",
    abilityText:
      "Gather units from your reinforcements equal to your starting units, (or as many as are available. You can also gather less units if you want). Place these units, in any combination, in the space area of any systems that contain 1 of your structures and no other players' ships, or on planets you control. Then, purge this card.",
    unlockCondition: "Have 3 scored objectives.",
    source: "ds",
  },
  {
