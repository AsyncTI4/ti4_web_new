...
export const leaders: LeaderData[] = [
  {
    ...
    "abilityText": "You may exhaust this card to galvanize another of that player's units in the destroyed unit's system.",
  ...
  },
  {
    ...
    "abilityText": "Your action cards cannot be canceled by \"Sabotage\" action cards. The Nekro Virus cannot place assimilator tokens on your components.",
  ...
  },
  {
    ...
    "abilityText": "You may purge this card to roll 1 die for each unit in its system that belongs to another player; if the result is equal to or greater than the galvanized unit's combat value, destroy that unit.",
  ...
  },
  {
    ...
    "abilityText": "You may exhaust this card to allow that player to ignore 1 prerequisite; if they do, you may place 1 infantry from your reinforcements into coexistence on a non-home planet they control.",
    "unlockCondition": "Always Unlocked",
    "source": "thunders_edge"
  },
  {
    ...
    "name": "Aello",
    "title": "Ikaten Kieros",
    "abilityWindow": "When another player spends resources to research a technology",
    "abilityText": "That player may reduce the cost by 1; if they do, gain 1 commodity or convert 1 of your commodities to a trade good.",
  ...
  },
  {
    ...
    "abilityText": "Purge this card and a non-unit upgrade technology you own or from your deck; then, purge all cards with the same name owned by other players and in other players' decks. Then, each player that purged a technology they owned researches another technology.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "thunders_edge"
  },
  {
  ...
  },
  {
    ...
    "title": "Courier Prime",
    "abilityWindow": "ACTION:",
    "abilityText": "Exhaust this card and draw 2 action cards; give 1 of those cards to another player.",
    "unlockCondition": "Always Unlocked",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityText": "Immediately retreat up to 2 of your ships from the active system to an adjacent system that does not contain another player's ships. Place a command token from your reinforcements into that system.",
    "unlockCondition": "Unknown",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityText": "You may choose to no longer be passed; if you do, gain 2 command tokens, draw 1 action card, and purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityWindow": "ACTION:",
    "abilityText": "Place any combination of up to 4 PDS or mechs onto planets you control; ready each planet that you place a unit on. Then, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
  ...
  },
  {
    ...
    "abilityText": "You may exhaust this card to return that token to that player's reinforcements.",
    "unlockCondition": "Always Unlocked",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityText": "You may exhaust this card; if you do, SPACE CANNON cannot be used against those ships. If they are not transporting units, they can also move through other players' ships.",
    "unlockCondition": "Always Unlocked",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityWindow": "At any time",
    "abilityText": "You can treat planets in systems that contain your ships as if they were controlled by you for the purpose of scoring secret objectives.",
  ...
  },
  {
    ...
    "abilityWindow": "ACTION:",
    "abilityText": "Place 1 of your plot cards in play with any other player's control token on it. Then, you may place any player's control token on 1 of your in-play plot cards; one plot cannot have two of the same player's tokens. Then, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityText": "You may exhaust this card; if you do, that player's opponent must destroy 1 of their ships of the same type in the active system.",
    "unlockCondition": "Always Unlocked",
    "source": "thunders_edge"
  },
  {
    ...
    "abilityWindow": "At any time",
    "abilityText": "Apply +1 to the result of each of your units' combat rolls in the Fracture.",
  ...
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, place 1 infantry from your reinforcements on a planet that does not contain other players’ units and is adjacent to 2 of your ground forces.",
  ...
  },
  {
    ...
    "abilityText": "You may force that player to remove 1 token from their tactic pool and return it to their reinforcements.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is not resolved and you predicted it or cast 5 or more votes for it, you may capture 1 unit from your reinforcements with a cost less than or equal to the number of players that cast votes for the resolved outcome.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "title": "Pathmaker",
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is not resolved and you predicted it or cast 5 or more votes for it, you may place or move a Creuss wormhole token into a non-home system that contains a planet controlled by a player who voted for the resolved outcome.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "You may predict aloud an outcome of this agenda. If your prediction is correct, you may place a frontier token in a system that does not contain any planets and does not already have a frontier token.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, each other player that cast 5 or more votes for that agenda may gain 1 commodity.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, place a control token on a technology you own. When a player researches a technology with your control token on it, gain 1 trade good.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityText": "You may exhaust this card and spend a command token from your strategy pool to ignore the effects of that agenda.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is not resolved and you predicted it or cast 5 or more votes for it, you may exhaust this card and remove 1 of your dreadnoughts in or adjacent to Mecatol Rex’s system from the board to discard the agenda instead; it is resolved with no effect and is not replaced.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is not resolved and you predicted it or cast 5 or more votes for it, you may exhaust this card to place 1 ship with a cost of 4 or less in a system containing your ships.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
  ...
  },
  {
    ...
    "abilityText": "You may exhaust this card. If you do, that player must cast at least 1 vote for an outcome of your choice, if able, or give you 2 trade goods or 1 promissory note.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is not resolved and you predicted it or cast 5 or more votes for it, you may gain a command token and place it in your strategy pool.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityText": "Choose a player. That player may exhaust 1 planet they control and cast additional votes equal to its influence value.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, look at the top card of the Relic deck, then you may exhaust this card to either put that card on the bottom of the deck, or purge 2 relic fragments of the same type to gain that card.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome and a player. If that player votes for that outcome, they cast additional votes equal to the number of technologies that player owns that you also own, and if that outcome is resolved, you count as having cast 5 votes for that outcome.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After the speaker votes on an agenda you cast 5 or more votes on:",
    "abilityText": "You may exhaust this card to change your vote to abstain, then ready up to 3 planets you control.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "title": "Broodmaster",
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, you may place up to 3 fighters from your reinforcements in a system that contains 1 or more of your ships.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, you may move 1 of your ships to an adjacent system that contains 1 or more of your ships or space docks.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is resolved and you predicted it or cast 5 or more votes for it, you may ready each planet you control in 1 system.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "title": "The Seeker",
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "Choose an outcome; if it is not resolved and you predicted it or cast 5 or more votes for it, you may exhaust this card to place or move 1 sleeper token onto a non-home planet that does not have a sleeper token and is controlled by a player who voted for the resolved outcome.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityWindow": "When you cast votes:",
    "abilityText": "Choose either your home planet or Mecatol Rex. If you control that planet, you can vote using its influence value without exhausting it, even if it is exhausted.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityText": "You may exhaust this card to look at the top 2 cards of the agenda deck. You may reveal 1 and put the rest on the bottom of the agenda deck; players vote on this agenda. You may prevent envoys from being used during this agenda.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "title": "Evangelist",
    "abilityWindow": "When you cast votes:",
    "abilityText": "You may remove 1 infantry from a planet you control to exhaust 1 adjacent planet controlled by another player and cast additional votes equal to that planet’s influence value.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityText": "You may exhaust this card and choose another player; that player may also resolve that action card as if they had played it.",
    "unlockCondition": "At the start of the agenda phase",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityName": "Political Data Nexus: Voice of the Council",
    "abilityWindow": "ACTION:",
    "abilityText": "You may discard 1 law from play. Gain the speaker token, then look at the top 5 cards of the agenda deck. Choose up to 2 to resolve as if you had cast up to 5 votes for an outcome of your choice; discard the rest. Then, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "homebrewReplacesID": "xxchahero",
    "source": "voices_of_the_council"
  },
  {
    ...
    "abilityName": "Operation Archon: Witching Hour",
    "abilityWindow": "After an agenda is revealed:",
    "abilityText": "You may cast up to 6 additional votes on this agenda. Predict aloud an outcome of this agenda. For each player that abstains or votes for another outcome, gain 1 trade goods and 1 command token. Then, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
  ...
  },
  {
    ...
    "abilityText": "Each token in your fleet supply increases the maximum number if non-fighter ships you can have in each system by 2 instead of 1.",
    "unlockCondition": "Have 3 scored objectives.",
  ...
  },
  {
    ...
    "abilityText": "Your dreadnaughts and flagship ignore anomalies movement restrictions, and gain +1 movement while moving to or through an anomaly.",
    "unlockCondition": "Win a space combat in or adjacent to an anomaly, where one of your dreadnaughts participated and survived.",
  ...
  },
  {
    ...
    "abilityText": "During the announce retreat step of combat: You may exhaust this agent and choose a player participating in the combat. That player cannot retreat.",
    "unlockCondition": "Always Unlocked",
  ...
  },
  {
    ...
    "abilityText": "After your ships move: For each ship that has a capacity value and moved through 1 or more wormholes, you may place 1 fighter from your reinforcements in the active system.",
    "unlockCondition": "",
  ...
  },
  {
    ...
    "abilityName": "Dimensional Anchor: Event Horizon",
    "abilityWindow": "ACTION:",
    "abilityText": "ACTION: Each other player rolls a die for each of their non-fighter ships that are in or adjacent to a system that contains a gravity rift; on a 1-3 capture that unit. If this causes a player's ground forces or fighters to be removed, also capture those units. Then, purge this card",
    "unlockCondition": "Have 3 scored objectives.",
  ...
  },
  {
    ...
    "abilityText": "Exhaust this card and the owner of that planet gains two trade goods",
    "unlockCondition": "Always Unlocked",
  ...
  },
  {
    ...
    "abilityWindow": "During combat",
    "abilityText": "Once per ground combat, when one of your infantry is destroyed, you may place it on any other planet you control.",
  ...
  },
  {
    ...
    "abilityWindow": "ACTION:",
    "abilityText": "During this game round, you can ignore your Limited Presence restriction. At the end of the round, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "memephilosopher"
  },
  {
  ...
  },
  {
    ...
    "title": "The Swift",
    "abilityWindow": "After a player activates a system",
    "abilityText": "you may exhaust this card to allow them to treat 1 system other than the active system as if it were a hyperlane connecting all adjacent systems together (treat all units in the system as if they do not exist until the conclusion of the tactical action)",
    "unlockCondition": "Always Unlocked",
    "source": "pbd2000"
  },
  {
    ...
    "abilityText": "you may remove 1 of your non-structure units from the game board and place it on a planet you control or in the space area of a system that contains at least 1 of your ships.",
    "unlockCondition": "Have at least 1 unit in: a system that contains an anomaly, a system that contains an alpha wormhole, a system that contains a beta wormhole.",
    "source": "pbd2000"
  },
  {
    "id": "ravenhero",
    ...
    "abilityWindow": "Action",
    "abilityText": "In every system that does not contain another player's ships, you may place a fighter or a destroyer from your reinforcements. Then, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "pbd2000"
  },
  {
  ...
  },
  {
    ...
    "abilityWindow": "ACTION:",
    "abilityText": "Gain 6 command tokens; you may redistribute any number of the command tokens on your command sheet. Then, purge this card. ",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "ignis_aurora"
  },
  {
  ...
  },
  {
    ...
    "abilityText": "You may exhaust this card to allow that player to produce 1 unit in that planet's system.",
    "unlockCondition": "Always Unlocked",
    "source": "eronous"
  },
  {
    ...
    "abilityWindow": "During combat:",
    "abilityText": "After you gain control of a planet: You may place 1 infantry from your reinforcements on that planet.",
    "unlockCondition": "Gain control of a planet that was owned by another player.",
    "source": "eronous"
  },
  {
    "id": "cantohero",
    ...
    "abilityText": "When another would player uses the ability of a hero, you may attach this card to that hero; the hero's ability is not used, and the hero is treated as blank while this card is attached. At the end of this game round, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "eronous"
  },
  {
    ...
    "abilityWindow": "ACTION:",
    "abilityText": "Exhaust this card and choose a player; that player can place up to 2 fighters in a system that contains no other players units.",
    "unlockCondition": "Always Unlocked",
    "source": "eronous"
  },
  {
    ...
    "abilityText": "After you activate a system that contains no planets. You may gain 1 trade good.",
  ...
  },
  {
    ...
    "abilityWindow": "After you move your flagship into a non-home system other than Mecatol Rex: ",
    "abilityText": "You may destroy all other players' units in that system and replace that system tile with the Eidolon gravity rift tile. If you do, purge this card and each planet card that corresponds to the replaced system tile.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "eronous"
  },
  {
    ...
    "abilityText": "You may exhaust this card to allow the defender to choose 1 of their opponent’s ships to place 1 ship of that type from their reinforcements in the active system.",
    "unlockCondition": "Always Unlocked",
    "source": "eronous"
  },
  {
    ...
    "abilityWindow": "At any time:",
    "abilityText": "When you would exhaust a planet for its resources you may instead use its influence value.",
    "unlockCondition": "Have 2 other players’ control tokens on your faction sheet.",
    "source": "eronous"
  },
  {
    "id": "shadowshero",
    ...
    "abilityWindow": "ACTION:",
    "abilityText": "Choose a non-home planet other than Mecatol Rex controlled by another player in a system that contains at least 1 or more of your units. Destroy all of that player's units on that planet. Place the “Grave World” token on that planet. Gain that planets' card and attach this card to that planet, you cannot lose this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "eronous"
  },
  {
    ...
    "abilityWindow": "",
    "abilityText": "This card has the Tier 1 text ability of each active protocol.",
    "unlockCondition": "Always Unlocked",
    "source": "eronous"
  },
  {
    ...
    "unlockCondition": "Have units with a combined PRODUCTION value of at least 4 in two non-home systems.",
    "source": "eronous"
  },
  {
    "id": "mechihero",
    ...
    "abilityWindow": "",
    "abilityText": "This card has the Tier 3 text ability of each active protocol. When you use this ability, purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "eronous"
  },
  {
    ...
    "abilityWindow": "",
    "abilityText": "You may exhaust this card to allow any player to spend influence as if it were resources.",
    "unlockCondition": "Always Unlocked",
    "source": "eronous"
  },
  {
    ...
    "abilityWindow": "After a player exhausts at least 1 planet to cast any number of votes:",
    "abilityText": "That player casts 5 additional votes. Then, exhaust this card.",
    "unlockCondition": "Always Unlocked",
    "source": "eronous"
  },
  {
  ...
  },
  {
    ...
    "abilityWindow": "After you move your flagship into a non-home system other than Mecatol Rex:",
    "abilityText": "You may destroy all other players' units in that system and replace that system tile with the Saeraphyme nebula tile. If you do, purge this card and each planet card that corresponds to the replaced system tile. Then, move any number of your ships into this system.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "eronous"
  },
  {
  ...
  },
  {
    ...
    "title": "Raid Leaders",
    "abilityWindow": "After you win a combat in a system that contains no planets or on a planet that contains a structure",
    "abilityText": "You may gain 1 trade good.",
  ...
  },
  {
    ...
    "title": "Delta Shield",
    "abilityWindow": "During movement [Note: any movement, not only the movement step]",
  ...
  },
  {
    ...
    "name": "Marik",
    "title": "the Wise",
    "abilityWindow": "After a player discards an action card other than “Sabotage”:",
    "abilityText": "You may exhaust this card to allow a different player to spend 3 influence to take that action card from the discard pile.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
    ...
    "title": "The Judicial",
    "abilityWindow": "After you win a space combat:",
    "abilityText": "You may force your opponent to give you 1 action card from their hand.",
  ...
  },
  {
    ...
    "title": "The Weaver",
    "abilityWindow": "Action",
    "abilityText": "Choose a system with a player’s command token. That player may remove one of their ships from that system and place it in that player’s home system if it contains no other player’s ships.",
    "unlockCondition": "Always Unlocked",
    "source": "other"
  },
  {
    ...
    "name": "Zraaqu",
    "title": "The Spinner",
    "abilityWindow": "At the start of a space combat in a system with your command token:",
    "abilityText": "If you are the defender, you may choose up to 2 of your opponent’s units. Those units roll 1 less combat die during the first round of this combat.",
  ...
  },
  {
    ...
    "abilityWindow": "ACTION",
    "abilityText": "Move up to 3 of your Command Tokens on the game board to an adjacent system. Then, purge this card. ",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "other"
  },
  {
    ...
    "title": "The Wise",
    "abilityWindow": "At the start of a space combat round:",
    "abilityText": "You may exhaust this card to repair up to 2 ships in the active system.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
    ...
    "abilityText": "You may move 1 of your structures onto a planet you control in the active system.",
  ...
  },
  {
    ...
    "abilityText": "You may exhaust this card to allow a player that was participating in that combat to gain 1 command token.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
    ...
    "abilityText": "You may use the BOMBARDMENT ability of any of your units in systems that do not contain any planets.",
  ...
  },
  {
    ...
    "title": "The Invincible",
    "abilityName": "Titles Are Silly",
    "abilityWindow": "After another player commits units to a planet you control that is not in another player's home system:",
    "abilityText": "You may purge this card to return all committed units to space and place 5 infantry from your reinforcements on that planet.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "balacasi"
  },
  {
    ...
    "title": "The Wise",
    "abilityWindow": "When 1 or more of a player’s units use PRODUCTION: ",
    "abilityText": "You may exhaust this card to apply +1 to the total PRODUCTION value of those units and reduce the combined cost of the produced units by 1.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
  ...
  },
  {
    ...
    "abilityName": "Titles Are Silly",
    "abilityWindow": "ACTION:",
    "abilityText": "Place this card face up in your play area. During the status phase of this round, you may score any number of your unscored status phase secret objectives that you satisfy the requirements for. At the end of the status phase, purge this card. ",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "balacasi"
  },
  {
  ...
  },
  {
    ...
    "title": "The Judicial",
    "abilityWindow": "When you resolve the primary or secondary ability of the Leadership strategy card:",
    "abilityText": "If you gained 1 or more command tokens from spending influence, gain 1 additional command token.",
  ...
  },
  {
    ...
    "abilityName": "Titles Are Silly",
    "abilityWindow": "ACTION:",
    "abilityText": "For each system that contains 1 or more of your ships, you may move 1 ship in that system into an adjacent system that doesn’t contain another player's ships.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "balacasi"
  },
  {
    ...
    "title": "The Wise",
    "abilityWindow": "ACTION:",
    "abilityText": "Exhaust this card to place 1 frontier token in a system that does not contain a planet.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
    ...
    "title": "The Judicial",
    "abilityWindow": "ACTION:",
    "abilityText": "Spend 1 token from your strategy pool to place 1 mech on a planet you control.",
    "unlockCondition": "Have 5 infantry that are not in or adjacent to your home system",
    "source": "balacasi"
  },
  {
    "id": "tyrishero",
    ...
    "abilityName": "Titles Are Silly",
    "abilityWindow": "At the start of your turn:",
    "abilityText": "You may purge this card. If you do, during this turn you may perform any number of actions and after each action, you may gain 1 commodity or convert 1 commodity to a trade good.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "balacasi"
  },
  {
    ...
    "abilityText": "You may exhaust this card. That player may place any number of those units in adjacent systems containing 1 or more of their ships.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
    ...
    "abilityText": "Gain 1 trade good per planet you control with a technology specialty matching any of the prerequisites of that technology.",
  ...
  },
  {
    ...
    "abilityName": "Titles Are Silly",
    "abilityWindow": "ACTION:",
    "abilityText": "Attach this card to 1 non-home planet on the game board that does not have a technology specialty. This planet is treated as having all four technology specialties. You ignore your SCATTERED LEGIONS faction ability on this planet. If you control that planet, you may place 1 PDS on that planet.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "balacasi"
  },
  {
    ...
    "title": "The Wise",
    "abilityWindow": "ACTION:",
    "abilityText": " Exhaust this card and choose another player. Choose a ship type that has a bounty token on that player’s faction sheet with a cost of 4 or less; the chosen player must choose 1 of their ships of that type in a system that contains 1 of their command tokens, if able. The chosen ship is destroyed and that player gains trade goods equal to its cost.",
    "unlockCondition": "Always Unlocked",
    "source": "balacasi"
  },
  {
    ...
    "abilityText": "For each result of 10, before applying modifiers, produce 1 additional hit.",
  ...
  },
  {
    ...
    "title": "The Invincible",
    "abilityName": "Titles Are Silly",
    "abilityWindow": "After you destroy an opponent’s War Sun or Flagship that has a bounty token on its unit space: ",
    "abilityText": "If you have a War Sun or Flagship on the game board, you may place this card in your play area and place 1 bounty token on the unit space of one of those ships. Then, gain 1 victory point.\nIf one of your ships with a bounty token on its unit space is destroyed, lose 1 victory point and purge this card.",
    "unlockCondition": "Have 3 scored objectives.",
    "source": "balacasi"
  },
  {
  ...
  },
  {
    ...
    "abilityWindow": "Action",
    "abilityText": "Gain 1 genome, 1 unit upgrade, and 1 technology. Then purge this card.",
    "unlockCondition": "Always Unlocked",
    "source": "twilights_fall"
  },
  {
  ...
  },
  {
    ...
    "abilityWindow": "Action",
    "abilityText": "Reveal 3 editcs; choose 1 to resolve and suffle the rest back into the edict deck. Then, purge this card.",
    "unlockCondition": "Always Unlocked",
    "source": "twilights_fall"
  },
  {
  ...
  },
  {
    ...
    "abilityWindow": "At the end of the status phase",
    "abilityText": "You may choose an bility owned by another player; they must either give you that ability or give you 2 other abilities. If you do, purge this card.",
    "unlockCondition": "Always Unlocked",
    "source": "twilights_fall"
  },
  {
