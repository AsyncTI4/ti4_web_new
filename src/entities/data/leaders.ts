...
export const leaders: LeaderData[] = [
  {
    ...
    type: "agent",
    name: "Dame Briar",
    title: "Bastion Valiant",
    abilityWindow: "When a player's unit is destroyed",
    abilityText:
  ...
  },
  {
    ...
    unlockCondition: "There are 3 galvanized units on the game board",
    source: "thunders_edge",
  },
  {
    id: "bastionhero",
    ...
    type: "hero",
    name: "Lyra Keen",
    tfName: "Intelligence Unshackled",
    title: "Shield of the Reef",
    tfTitle: "Bastion Paradigm",
    abilityName: 'Entity 4X41A "Apollo" - Intelligence Unshackled',
    abilityWindow: "When one of your galvanized units is destroyed",
    tfAbilityWindow: "When one of your units is destroyed",
    abilityText:
      "You may purge this card to roll 1 die for each unit in its system that belongs to another player; if the result is equal to or greater than the galvanized unit's combat value, destroy that unit.",
    tfAbilityText:
  ...
  },
  {
    ...
    name: "Doctor Carrina",
    title: "Oceanographer",
    abilityWindow: "When another player researches a technology",
    abilityText:
      "You may exhaust this card to allow that player to ignore 1 prerequisite; if they do, you may place 1 infantry from your reinforcements into coexistence on a non-home planet they control.",
    unlockCondition: "Always Unlocked",
    source: "thunders_edge",
  },
  {
    id: "deepwroughtcommander",
    faction: "deepwrought",
    type: "commander",
    name: "Aello",
    title: "Ikaten Kieros",
    ...
    unlockCondition: "Have an ocean card in play.",
    source: "thunders_edge",
  },
  {
    id: "deepwroughthero",
    ...
    type: "hero",
    name: "Ta Zern",
    title: "Conclave Founder",
    abilityName: "Wave Function Collapse - The Laws Unwritten",
    abilityWindow: "ACTION:",
    abilityText:
      "Purge this card and a non-unit upgrade technology you own or from your deck; then, purge all cards with the same name owned by other players and in other players' decks. Then, each player that purged a technology they owned researches another technology.",
    unlockCondition: "Have 3 scored objectives.",
    source: "thunders_edge",
  },
  {
    ...
    type: "agent",
    name: "Ahk Ravin",
    tfName: "Breach Genome",
    title: "Forlorn Shadow",
    tfTitle: "Instability",
    abilityWindow: "ACTION:",
    abilityText:
      "Exhaust this card to choose 1 player. That player may swap the position of 2 of their ships in any systems; they may transport units when they swap. [Note: async has decided that a swap is likely to be a move and thus will obey anomaly movement restrictions.]",
    unlockCondition: "Always Unlocked",
    source: "thunders_edge",
  },
  {
  ...
  },
  {
    ...
    type: "agent",
    name: "Kan Kip Rel",
    tfName: "Courier Genome",
    title: "Courier Prime",
    tfTitle: "Reliability",
    abilityWindow: "ACTION:",
    abilityText:
      "Exhaust this card and draw 2 action cards; give 1 of those cards to another player.",
    unlockCondition: "Always Unlocked",
    source: "thunders_edge",
  },
  {
    ...
    type: "commander",
    name: "Watchful Ojz",
    title: "Actuary General",
    abilityWindow: "When you declare a retreat",
    abilityText:
    ...
    unlockCondition: "Be the last person to pass during the Action Phase",
    source: "thunders_edge",
  },
  {
    id: "ralnelhero",
    ...
    name: "Director Nel",
    tfName: "",
    title: "Acquisitive Mind",
    tfTitle: "",
    abilityName: "Signal Intrusion - Limit Break",
    abilityWindow: "After the last player passes",
    abilityText:
  ...
  },
  {
    ...
    tfTitle: "",
    abilityName: "Planetary Defense Nexus - Aegis",
    abilityWindow: "ACTION:",
    abilityText:
  ...
  },
  {
    ...
    abilityWindow: "At any time",
    abilityText:
      "You can treat planets in systems that contain your ships as if they were controlled by you for the purpose of scoring secret objectives.",
    unlockCondition: "Have a plot card in play",
    source: "thunders_edge",
  },
  {
    id: "firmamenthero",
    ...
    name: "Sharsiss",
    tfName: "",
    title: "The Coiling Void",
    tfTitle: "",
    abilityName: "The Blade Beckons - Knife in the Back",
    abilityWindow: "ACTION:",
    abilityText:
      "Place 1 of your plot cards in play with any other player's control token on it. Then, you may place any player's control token on 1 of your in-play plot cards; one plot cannot have two of the same player's tokens. Then, purge this card.",
    unlockCondition: "Have 3 scored objectives.",
    source: "thunders_edge",
  },
  {
    ...
    name: "Vos Hollow",
    tfName: "",
    title: "Hunger Burning",
    tfTitle: "",
    abilityWindow: "When a player's ship is destroyed during any combat",
    abilityText:
  ...
  },
  {
    ...
    unlockCondition: "Have units in the Fracture.",
    source: "thunders_edge",
  },
  {
    id: "obsidianhero",
    ...
    tfName: "",
    title: "Sanity Snapped",
    tfTitle: "",
    abilityName: "The Blade Revealed - Eternity's End",
    abilityWindow: "ACTION:",
    abilityText: "Ready all of your planets. Then, purge this card.",
    unlockCondition: "Have 3 scored objectives.",
    source: "thunders_edge",
  },
  {
  ...
  },
  {
    ...
    type: "agent",
    name: "Acamar",
    tfName: "Cosmic Genome",
    title: "The Gift of Night",
    tfTitle: "Enlightenment",
    abilityWindow:
  ...
  },
  {
    ...
    type: "agent",
    name: "Garv and Gunn",
    tfName: "Curious Genome",
    title: "Plucky Archaeologists",
    tfTitle: "Perseverance",
  ...
  },
  {
    ...
    type: "agent",
    name: "Nekro Malleon",
    tfName: "Recurisve Genome",
    title: "The Shifting Host",
    tfTitle: "_ERROR_ERROR_ERROR_ERROR_",
    abilityWindow: "During the action phase:",
    abilityText:
  ...
  },
  {
    ...
    tfName: "Investment Genome",
    title: "Sumerian Overseer",
    tfTitle: "Echo of Means",
  ...
  },
  {
    ...
    tfName: "Deployment Genome",
    title: "Shikrai General",
    tfTitle: "Echo of Conflict",
    abilityWindow: "At the end of a player's turn:",
    abilityText:
  ...
  },
  {
    ...
    type: "agent",
    name: "The Thundarian",
    tfName: "Temporal Genome",
    title: "Temporal Engima",
    tfTitle: "Echo of Time",
  ...
  },
  {
    ...
    type: "agent",
    name: "Brother Milor",
    tfName: "Splitting Genome",
    title: "Purifed by Fire",
    tfTitle: "Replication",
    tfAbilityWindow: "After a player's destroyer or cruiser is destroyed",
    abilityWindow:
      'After a player\'s unit is destroyed during combat [Note: "during combat" is wording from the latest version of this agent]:',
    abilityText:
  ...
  },
  {
    ...
    abilityText:
      "You may cast up to 6 additional votes on this agenda. Predict aloud an outcome of this agenda. For each player that abstains or votes for another outcome, gain 1 trade good and 1 command token. Then, purge this card.",
    unlockCondition: "Have 3 scored objectives.",
    source: "pok",
  },
  {
  ...
  },
  {
    ...
    tfAbilityText:
      "Ready a planet you control and attach this card to it. Its resource and influence values are each increased by 3, and it gains the SPACE CANNON 5(x3) ability as if it were a unit.",
    unlockCondition: "Have 3 scored objectives.",
    source: "pok",
  },
  {
  ...
  },
  {
    ...
    title: "Raid Leaders",
    abilityWindow:
      "After you win a combat in a system that contains no planets or on a planet that contains a structure",
    abilityText: "You may gain 1 trade good.",
  ...
  },
  {
    ...
    abilityWindow: "When you cast votes:",
    abilityText:
      "When you cast votes: You may remove up to 4 of your infantry from the game board to cast 1 additional vote for each unit removed.",
  ...
  },
  {
    ...
    title: "Delta Shield",
    abilityWindow:
      "During movement [Note: any movement, not only the movement step]",
    abilityText:
      "For each infantry you transport, you may replace that unit with 1 fighter. \n\n [Note: not reliant on the first half of this ability] You may use the SPACE CANNON of 1 of your units against ships that are adjacent to that unit's system.",
  ...
  },
  {
    ...
    abilityText:
      "You may use that unit’s ANTI-FIGHTER BARRAGE instead. You cannot use this ability during the first round of space combat.",
  ...
  },
  {
    ...
    title: "the Wise",
    abilityWindow:
      "After a player discards an action card other than “Sabotage”:",
    abilityText:
      "You may exhaust this card to allow a different player to spend 3 influence to take that action card from the discard pile.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    ...
    abilityWindow: "After you win a space combat:",
    abilityText:
      "You may force your opponent to give you 1 action card from their hand.",
    unlockCondition: "Discard an action card after you win a combat",
    source: "balacasi",
  },
  {
    id: "arvaxihero",
    ...
    abilityName: "Titles Are Silly",
    abilityWindow:
      "At the start of a space combat that you are participating in:",
    abilityText:
      "You may purge this card. If you do, roll 1 die for each of your non-fighter ships in this system. For each result equal to or greater than that ship's combat value, produce 1 hit; your opponent must assign it to 1 of their ships. During this combat, both you and your opponent ignore all of your opponent’s non-warsun unit upgrade technologies.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    abilityWindow: "Action",
    abilityText:
      "Choose a system with a player’s command token. That player may remove one of their ships from that system and place it in that player’s home system if it contains no other player’s ships.",
    unlockCondition: "Always Unlocked",
    source: "other",
  },
  {
    id: "arachiancommander",
    faction: "arachian",
    type: "commander",
    name: "Zraaqu",
    title: "The Spinner",
    abilityWindow:
      "At the start of a space combat in a system with your command token:",
    abilityText:
      "If you are the defender, you may choose up to 2 of your opponent’s units. Those units roll 1 less combat die during the first round of this combat.",
    unlockCondition: "Have 6 of your Command Tokens on the game board",
    source: "other",
  },
  {
    id: "arachianhero",
    ...
    type: "hero",
    name: "Zhossox",
    title: "Spider in Chief",
    abilityName: "Master Web",
    abilityWindow: "ACTION",
    abilityText:
      "Move up to 3 of your Command Tokens on the game board to an adjacent system. Then, purge this card. ",
    unlockCondition: "Have 3 scored objectives.",
    source: "other",
  },
  {
    ...
    abilityWindow: "At the start of a space combat round:",
    abilityText:
      "You may exhaust this card to repair up to 2 ships in the active system.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    ...
    faction: "xan",
    type: "commander",
    name: "Pospician Meraldo",
    title: "The Judicial",
    abilityWindow: "After you perform a tactical action:",
    abilityText:
      "You may move 1 of your structures onto a planet you control in the active system.",
    unlockCondition: "Cast more votes than any other player on an agenda",
    source: "balacasi",
  },
  {
    id: "xanhero",
    faction: "xan",
    type: "hero",
    name: "Flavius Stellarius",
    title: "The Invincible",
    abilityName: "Titles Are Silly",
    abilityWindow: "ACTION:",
    abilityText:
      "ACTION: Gain 1 trade good for each damaged unit on the game board. Then, repair all of your damaged units and choose any number of other players. For each chosen player, repair all of their damaged units that are in or adjacent to a system that contains 1 of your space docks.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    name: "Valzor",
    title: "The Wise",
    abilityWindow: "At the end of a space combat:",
    abilityText:
      "You may exhaust this card to allow a player that was participating in that combat to gain 1 command token.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    ...
    name: "Sirok",
    title: "The Judicial",
    abilityWindow: "When 1 or more of your units use BOMBARDMENT:",
    abilityText:
      "You may use the BOMBARDMENT ability of any of your units in systems that do not contain any planets.",
    unlockCondition: "Have units in 2 systems that do not contain planets.",
    source: "balacasi",
  },
  {
    id: "kalorahero",
    ...
    abilityName: "Titles Are Silly",
    abilityWindow:
      "After another player commits units to a planet you control that is not in another player's home system:",
    abilityText:
      "You may purge this card to return all committed units to space and place 5 infantry from your reinforcements on that planet.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    abilityWindow: "When 1 or more of a player’s units use PRODUCTION: ",
    abilityText:
      "You may exhaust this card to apply +1 to the total PRODUCTION value of those units and reduce the combined cost of the produced units by 1.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    id: "lunariumcommander",
    faction: "lunarium",
    type: "commander",
    name: "Syphrydon Umbas",
    title: "The Judicial",
    abilityWindow: "After you score a secret objective:",
    abilityText: "You may draw 1 secret objective.",
    unlockCondition: "Have 4 carriers on the game board",
    source: "balacasi",
  },
  {
    id: "lunariumhero",
    faction: "lunarium",
    type: "hero",
    name: "Anima Scrutator",
    title: "The Invincible",
    abilityName: "Titles Are Silly",
    abilityWindow: "ACTION:",
    abilityText:
      "Place this card face up in your play area. During the status phase of this round, you may score any number of your unscored status phase secret objectives that you satisfy the requirements for. At the end of the status phase, purge this card. ",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    abilityWindow: "ACTION:",
    abilityText:
      "Exhaust this card to choose a player. That player may move 1 of their ships into an adjacent system that doesn’t contain any other player's ships. If the ship started this action in a system that contains that player's command token, they place a command token from their reinforcements into the target system.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    ...
    title: "The Judicial",
    abilityWindow:
      "When you resolve the primary or secondary ability of the Leadership strategy card:",
    abilityText:
      "If you gained 1 or more command tokens from spending influence, gain 1 additional command token.",
    unlockCondition: "Have 2 control tokens on this card",
    source: "balacasi",
  },
  {
    id: "onyxxahero",
    faction: "onyxxa",
    type: "hero",
    name: "Grandmaster Xel'Kor",
    title: "The Invincible",
    abilityName: "Titles Are Silly",
    abilityWindow: "ACTION:",
    abilityText:
      "For each system that contains 1 or more of your ships, you may move 1 ship in that system into an adjacent system that doesn’t contain another player's ships.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    faction: "tyris",
    type: "agent",
    name: "Echo-Weaver Tzara",
    title: "The Wise",
    abilityWindow: "ACTION:",
    abilityText:
      "Exhaust this card to place 1 frontier token in a system that does not contain a planet.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    ...
    faction: "tyris",
    type: "commander",
    name: "Chrono-Tactician Xelthar",
    title: "The Judicial",
    abilityWindow: "ACTION:",
    abilityText:
      "Spend 1 token from your strategy pool to place 1 mech on a planet you control. When a public objective is revealed, you may place 1 infantry on a planet you control.",
    unlockCondition:
      "Have 5 infantry that are not in or adjacent to your home system",
    source: "balacasi",
  },
  {
    id: "tyrishero",
    faction: "tyris",
    type: "hero",
    name: "Fatebreaker Azhurak",
    title: "The Invincible",
    abilityName: "Titles Are Silly",
    abilityWindow: "At the start of your turn:",
    abilityText:
      "You may purge this card. If you do, during this turn you may perform any number of actions and after each action, you may gain 1 commodity or convert 1 commodity to a trade good.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    name: "The Vizier",
    title: "The Wise",
    abilityWindow: "When a player produces fighters in a system: ",
    abilityText:
      "You may exhaust this card. That player may place any number of those units in adjacent systems containing 1 or more of their ships.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    ...
    name: "The Synthesist",
    title: "The Judicial",
    abilityWindow: "When you research a non-unit upgrade technology: ",
    abilityText:
      "Gain 1 trade good per planet you control with a technology specialty matching any of the prerequisites of that technology.",
    unlockCondition: "Control 3 planets with technology specialties.",
    source: "balacasi",
  },
  {
    id: "vyserixhero",
    ...
    abilityWindow: "ACTION:",
    abilityText:
      "Attach this card to 1 non-home planet on the game board that does not have a technology specialty. This planet is treated as having all four technology specialties. You ignore your SCATTERED LEGIONS faction ability on this planet. If you control that planet, you may place 1 PDS on that planet.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
    ...
    faction: "zephyrion",
    type: "agent",
    name: "Rhino the Adventurer",
    title: "The Wise",
    abilityWindow: "ACTION:",
    abilityText:
      " Exhaust this card and choose another player. Choose a ship type that has a bounty token on that player’s faction sheet with a cost of 4 or less; the chosen player must choose 1 of their ships of that type in a system that contains 1 of their command tokens, if able. The chosen ship is destroyed and that player gains trade goods equal to its cost.",
    unlockCondition: "Always Unlocked",
    source: "balacasi",
  },
  {
    id: "zephyrioncommander",
    faction: "zephyrion",
    type: "commander",
    name: "John Perro",
    title: "The Judicial",
    abilityWindow: "When 1 or more of your units make rolls for SPACE CANNON:",
    abilityText:
      "For each result of 10, before applying modifiers, produce 1 additional hit.",
    unlockCondition: " Have 7 Units that have SPACE CANNON on the game board",
    source: "balacasi",
  },
  {
    id: "zephyrionhero",
    faction: "zephyrion",
    type: "hero",
    name: "Monturak Homotol",
    title: "The Invincible",
    abilityName: "Titles Are Silly",
    abilityWindow:
      "After you destroy an opponent’s War Sun or Flagship that has a bounty token on its unit space: ",
    abilityText:
      "If you have a War Sun or Flagship on the game board, you may place this card in your play area and place 1 bounty token on the unit space of one of those ships. Then, gain 1 victory point.\nIf one of your ships with a bounty token on its unit space is destroyed, lose 1 victory point and purge this card.",
    unlockCondition: "Have 3 scored objectives.",
    source: "balacasi",
  },
  {
  ...
  },
  {
    ...
    title: "Erudition",
    abilityWindow:
      "When a player initiates a splice [Note: in async, play this before starting the splice]",
    abilityText:
  ...
  },
  {
    ...
    abilityText:
      "You may exhaust this card to roll 1 die. If the result is equal to or greater than that unit's combat value, their opponent must choose and destroy 1 of their units.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
    ...
    title: "Jol Nar Paradigm",
    abilityWindow: "ACTION:",
    abilityText:
      "Gain 1 genome, 1 unit upgrade, and 1 technology. Then purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
    ...
    type: "hero",
    name: "Devour World",
    title: "Nekro Paradigm",
    abilityWindow: "ACTION:",
    abilityText:
      "Choose a planet that has a technology specialty in a system that contains your units. Destroy any other player's units on that planet. Gain trade goods equal to that planet's combined resource and influence values and draw 1 ability. Then, purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
    ...
    title: "Xxcha Paradigm",
    abilityWindow: "ACTION:",
    abilityText:
      "Reveal 3 editcs; choose 1 to resolve and suffle the rest back into the edict deck. Then, purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
    ...
    type: "hero",
    name: "Witching Hour",
    title: "Keleres Xxcha Paradigm",
    abilityWindow: "ACTION:",
    abilityText:
      "Choose a player other than the current speaker to gain the speaker token. Choose a player other than the tyrant to gain the benediction token. Then purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
  ...
  },
  {
    ...
    title: "Naalu Paradigm",
    abilityWindow: "At the end of the status phase",
    abilityText:
      "You may choose an ability owned by another player; they must either give you that ability or give you 2 other abilities. If you do, purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
    ...
    type: "hero",
    name: "Eternity's end",
    title: "Obsidian Paradigm",
    abilityWindow: "ACTION:",
    abilityText:
      "Search the ability, unit upgrade, or genome deck for a card and gain it. Then, purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
  {
  ...
  },
  {
    ...
    type: "hero",
    name: "Event Horizon",
    title: "Cabal Paradigm",
    abilityWindow: "ACTION:",
    abilityText:
      "Each other player rolls a die for each of their non-fighter ships that are in or adjacent to a system that contains a gravity rift; on a 1-5, return that unit to their reinforcements. Then, purge this card.",
    unlockCondition: "Always Unlocked",
    source: "twilights_fall",
  },
];
