...
export const units: Unit[] = [
  ...
  },
  {
    ...
    capacityValue: 3,
    isStructure: true,
    ability: "The resource value of this planet is increased by 2.",
  },
  {
    id: "belkosea_fighter",
    baseType: "fighter",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "This ship can transport any number of infantry and fighters, and they do not count against this ships capacity.",
  },
  {
    id: "blacktf_mech",
    baseType: "mech",
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "After you gain control of a planet that contains this unit, you may ready that planet.",
  },
  {
    id: "carrier",
    baseType: "carrier",
  ...
  },
  {
    ...
    baseType: "celagrom",
    asyncId: "celagrom",
    name: "Fake Celagrom Flagship Basetype",
    source: "ds",
  },
  {
    id: "celdauri_celagrom",
    baseType: "celagrom",
    asyncId: "celagrom",
    name: "The Celagrom",
    source: "ds",
    ...
    isShip: true,
    ability:
      "You assign hits this unit produces. While you control another flagship, this unit rolls 1 additional combat die.",
  },
  {
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "You may ignore the movement effects of anomalies in the system that contains this unit.",
  },
  {
    id: "eidolon_mech",
    baseType: "mech",
  ...
  },
  {
    ...
    canBeDirectHit: true,
    isGroundForce: true,
    ability: "When this unit is produced, place it on any planet you control.",
  },
  {
    id: "hacan_flagship",
    baseType: "flagship",
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "At the end of a ground combat you won in which this unit participated, you may return this unit to your reinforcement to draw 1 unit upgrade technology.",
  },
  {
    id: "plenaryorbital",
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "This unit participates in space combat as if it were a ship. For each anomaly this unit is in or adjacent to, apply +1 to this units combat rolls.",
  },
  {
    id: "qhet_cruiser",
    baseType: "cruiser",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "DEPLOY: At the start of your turn, you may discard one of your abilities or genomes to place this unit from your reinforcement into a system that contains your ships.",
  },
  {
    id: "redtf_mech",
    baseType: "mech",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "Other player's units in this system lose PLANETARY SHIELD. This unit is also a station with a resource value of 2. When you would exhaust this station’s planet card, this unit becomes damaged instead.",
    imageURL: "/hover_images/techs/ds/terrafactory_2.jpg",
  },
  {
    id: "saar_flagship",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "DEPLOY: After another player activates a system that contains 1 of your structures and no other player's ships, you may spend 4 influence to place this unit in that system.",
  },
  {
    id: "shadows_mech",
    baseType: "mech",
  ...
  },
  {
    ...
    sustainDamage: true,
    isShip: true,
    ability: 'This unit cannot be destroyed by "Spark" action cards.',
  },
  {
    id: "tf-dragonfreed",
    baseType: "warsun",
    ...
    isShip: true,
    ability:
      "While you own this card, you can only have 1 war sun. When this unit uses its BOMBARDMENT ability, it uses it against every planet in its system and each adjacent system, even yours, ignoring planetary shield.",
  },
  {
    id: "tf-echoofascension",
    baseType: "flagship",
    asyncId: "fs",
    ...
    isShip: true,
    ability:
      "Keep this card in your play area [it acts in addition to your normal flagship]; decrease the combat value of your flagship by 1, increase the number of combat dice it rolls by 1, increase its move value by 1, and increase its capacity by 2.",
  },
  {
    id: "tf-eidolonlandwaster",
    baseType: "mech",
    asyncId: "mf",
    ...
    isGroundForce: true,
    ability:
      "Keep this card in your play area [it acts in addition to your normal mech card]; your mechs roll 1 additional die during combat.",
  },
  {
    id: "tf-eidolonterminus",
    baseType: "mech",
    asyncId: "mf",
    ...
    isGroundForce: true,
    ability:
      "Keep this card in your play area [it acts in addition to your normal mech card]; the COMBAT value of your mechs is reduced by 1.",
  },
  {
    id: "tf-exile",
    baseType: "destroyer",
  ...
  },
  {
    ...
    baseType: "fighter",
    asyncId: "ff",
    name: "Hybrid Crystral Fighter (TF)",
    source: "twilights_fall",
    faction: "naalu",
    moveValue: 2,
    capacityUsed: 1,
  ...
  },
  {
    ...
    isStructure: true,
    ability:
      "This unit's PRODUCTION value is equal to 2 more than the resource value of this planet. The resource value of this planet is increased by 2. Up to 3 fighters in this system do not count against your ships' capacity.",
  },
  {
    id: "tf-heltitan",
    baseType: "pds",
    ...
    isGroundForce: true,
    ability:
      "This unit is treated as both a structure and a ground force. It cannot be transported. You may use this unit's SPACE CANNON ability against ships that are in adjacent systems.",
  },
  {
    id: "tf-justicerrail",
    baseType: "pds",
    ...
    isStructure: true,
    ability:
      "You may use this unit's SPACE CANNON ability against ships that are adjacent to this unit's system. Hits produced by this unit must be assigned to non-fighter ships if able.",
  },
  {
    id: "tf-keepermatrix",
    baseType: "pds",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "This unit may move without being transported. Fighters in excess of your ships' capacity count against your fleet pool. This unit can be committed during an invasion; either return it to the space area or replace it with 1 infantry at the end of combat.",
  },
  {
    id: "tf-productionbiomes",
    baseType: "spacedock",
    asyncId: "sd",
    faction: "hacan",
    ...
    isStructure: true,
    ability:
      "Up to 3 fighters in this system do not count against your ships' capacity. When this unit uses PRODUCTION, you may spend 1 token from your strategy pool to gain 4 trade goods and choose another player to gain 2 trade goods.",
  },
  {
    id: "tf-pws",
    baseType: "warsun",
    asyncId: "ws",
    name: "Prototype War Sun (TF)",
    source: "twilights_fall",
    faction: "muaat",
    moveValue: 2,
    capacityValue: 6,
    ...
    isShip: true,
    ability:
      "Other player's units in this system lose PLANETARY SHIELD. This unit and other units moving at the same time can move into and through supernovas.",
  },
  {
    id: "tf-saggitaria",
    baseType: "cruiser",
  ...
  },
  {
    ...
    isGroundForce: true,
    ability:
      "Keep this card in your play area [it acts in addition to your normal mech card]; the COST of your mechs is reduced by 1.",
  },
  {
    id: "tf-vortexer",
    baseType: "carrier",
    ...
    isShip: true,
    ability:
      "Capture other players' infantry and fighters that are destroyed or removed in this unit's system or an adjacent system. At the start of your turn you may spend captured infantry or fighters to place equivalent units from your reinforcement in this system.",
  },
  {
    id: "tf-yinclone",
    baseType: "infantry",
    ...
    isGroundForce: true,
    ability:
      "After this unit is destroyed or removed, place the unit on this card. At the start of the status phase, place each unit that is on this card on a planet you control. [Note: abilities that remove and then place will not trigger this ability.]",
  },
  {
    id: "tf-yssarilinfantry",
    baseType: "infantry",
    asyncId: "gf",
    name: "Guild Agents",
    faction: "yssaril",
    ...
    isGroundForce: true,
    ability:
      "Once per action, after you move an infantry into a system that contains another player's units, you may look at that player's action cards and take 1 of them. [Note: in async, and with Dane's assent, this ability was modified to trigger only once per action]",
  },
  {
    id: "tf_warsun",
    baseType: "warsun",
  ...
  },
  {
    ...
    isShip: true,
    ability:
      "This unit cannot be destroyed by “Direct Hit” action cards. When this unit produces a hit, you may repair it. While this unit is not damaged, you may reroll its combat roll.",
  },
  {
    id: "tyrantslament",
